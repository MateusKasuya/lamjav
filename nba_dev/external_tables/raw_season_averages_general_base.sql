...
-- Format: NEWLINE_DELIMITED_JSON
  ...
  CREATE OR REPLACE EXTERNAL TABLE `sigma-heuristic-469419-h3.nba.raw_season_averages_general_base`
  OPTIONS (
      format = 'NEWLINE_DELIMITED_JSON',
      uris = [
          'gs://smartbetting-landing/nba/season_averages/general/base/regular/2025/raw_nba_season_averages_general_base_regular_2025.json'
