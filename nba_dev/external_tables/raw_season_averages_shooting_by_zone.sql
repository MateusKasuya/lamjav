...
-- ============================================================================
  ...
  CREATE OR REPLACE EXTERNAL TABLE `sigma-heuristic-469419-h3.nba.raw_season_averages_shooting_by_zone`
  OPTIONS (
      format = 'NEWLINE_DELIMITED_JSON',
      uris = [
          'gs://smartbetting-landing/nba/season_averages/shooting/by_zone/regular/2025/raw_nba_season_averages_shooting_by_zone_regular_2025.json'
